...
const STOPWORDS = new Set([
  'yang', 'dan', 'atau', 'dengan', 'untuk', 'dari', 'ini', 'itu', 'pada', 'ke',
  'di', 'adalah', 'akan', 'tidak', 'juga', 'karena', 'setelah', 'sebuah',
  'the', 'and', 'for', 'with', 'from', 'that', 'this', 'have', 'are', 'was',
  'your', 'you', 'not', 'but', 'they', 'there', 'about', 'what', 'when',
  'them', 'then', 'than', 'just', 'would', 'could', 'should', 'these'
])
